...
<div id="wrapper" class="easyui-panel" title="OLAH DATA USER" collapsed="true" collapsible="true" style="width:200px;height:auto;padding:10px;">
<a href="#" class="easyui-linkbutton" iconCls="icon-shop" plain="true" onClick="addTab('View Proposal','tampil')">Lihat Proposal</a><br />
<a href="#" class="easyui-linkbutton" iconCls="icon-stack-f" plain="true" onClick="addTab('Biodata Dosen','tampil7')">Biodata</a><br />
...
<a class="easyui-linkbutton" iconCls="icon-logout" plain="true" href="<?php echo site_url('kordinator/c_kordinator'); ?>">Kembali</a>
</div></div>
...
<div id="wrapper" title="Home" style="padding-top:20px; text-align:center; background-repeat:no-repeat;background-color:#FFF;"> <img src="<?php echo base_url('mycss/images/logo1.png')?>"width="491" height="491" />
</div>
</div>
</div>
</div>
