...
<a href="#" class="easyui-linkbutton" iconCls="icon-user" plain="true" onClick="addTab('Cek Pembimbing','tampil5')">Cek Pembimbing</a>
<a href="#" class="easyui-linkbutton" iconCls="icon-report1" plain="true" onClick="addTab('Form Bimbingan','tampil21')">Form Bimbingan</a><br/>
<a href="#" class="easyui-linkbutton" iconCls="icon-identitas" plain="true" onClick="addTab('Biodata Mahasiswa','tampil7')">Biodata</a><br />
...
<a href="#" class="easyui-linkbutton" iconCls="icon-report2" plain="true" onClick="addTab('Test','uploadlaporan')">Test</a><br/>
</div>
<br />
<div id="wrapper" class="easyui-panel" title="AKSES" collapsed="true" collapsible="true" style="width:200px;height:auto;padding:10px;">

<a class="easyui-linkbutton" iconCls="icon-logout" plain="true" href="<?php echo site_url('mahasiswa/c_mahasiswa/formditerima'); ?>">kembali</a>
</div></div>
