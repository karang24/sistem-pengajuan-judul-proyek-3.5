...
<div align="justify" class="panel panel-default">
  ...
  <?=$this->session->flashdata('pesan')?>
     <form  action="<?php echo site_url('mahasiswa/upload/update_proposal1'); ?>" method="post" enctype="multipart/form-data">
...
<tr>
          ...
          <td>
            <div class="col-sm-15"><textarea class="form-control" maxlength="100" class="textarea-none-resize" name="judul"></textarea>
            </div>
            </td>
         </tr>
            <div class="col-sm-10">
         ...
         <tr>
          ...
          <td>
            <div class="col-sm-20">
                <p>
                  <select class="form-control" name="textket" style="width:150px;" required="true">
                    <option value="proposal1" disabled>proposal 1</option>
                    <option value="proposal2" disabled>proposal2</option>
                    <option value="proposal3" disabled>proposal3</option>
