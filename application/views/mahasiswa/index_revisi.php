...
<a href="#" class="easyui-linkbutton" iconCls="icon-shop" plain="true" onClick="addTab('proposal','proposalrevisi')">Pengajuan Proposal</a><br />
...
<a class="easyui-linkbutton" iconCls="icon-logout" plain="true" href="<?php echo site_url('mahasiswa/c_mahasiswa/formrevisi'); ?>">kembali</a>
</div></div>
</div>
</div>
</div>
