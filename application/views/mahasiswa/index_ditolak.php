...
<a href="#" class="easyui-linkbutton" iconCls="report2" plain="true" onClick="addTab('proposal','proposalditolak')">Pengajuan Proposal</a><br />
...
<a class="easyui-linkbutton" iconCls="icon-logout" plain="true" href="<?php echo site_url('mahasiswa/c_mahasiswa/formtolak'); ?>">kembali</a>
</div></div>
