...
?>
     ...
     <form  action="<?php echo site_url('mahasiswa/upload/update_proposal'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-20">
                <p>
                  <select class="form-control" name="textket" style="width:120px;" required="true">
                    ...
                    <option value="revisi" disabled>revisi proposal</option>
                  </select>
                </p>
