...
<a href="#" class="easyui-linkbutton" iconCls="icon-shop" plain="true" onClick="addTab('Data Mahasiswa','tampil2')">Cek Mahasiswa</a><br />
<a href="#" class="easyui-linkbutton" iconCls="icon-stack-f" plain="true" onClick="addTab('Biodata Dosen','tampil7')">Biodata Dosen</a><br />
...
<a class="easyui-linkbutton" iconCls="icon-logout" plain="true" href="<?php echo site_url('dosen/c_dosen'); ?>">Kembali</a>
</div></div>
