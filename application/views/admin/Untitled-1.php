...
<a href="#" class="easyui-linkbutton" iconCls="icon-stack-f" plain="true" onClick="addTab('Dosen','tampil2')">Data Dosen</a><br />
<a href="#" class="easyui-linkbutton" iconCls="icon-report2" plain="true" onClick="addTab('mahasiswa','tampil4')">Data Mahasiswa</a><br />
</div>
<br />
